...
<body class="sb-nav-fixed text-light bg-secondary ">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="home_petugas.php">Aplikasi Kasir</a>
        <!-- Sidebar Toggle-->
            ...
            <footer class="py-4 bg-dark mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">UJIKOM Allief Firdaus Jundan Muttaqinen &copy; Aplikasi Kasir 2024 </div>
